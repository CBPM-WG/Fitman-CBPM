...
@XmlRootElement(name = "selectService")
public class SelectService {
    ...
    @XmlElementRef(name = "url", namespace = "http://businesslogic.webn1.atosresearch.eu", type = JAXBElement.class)
    protected JAXBElement<String> url;
    @XmlElementRef(name = "operation", namespace = "http://businesslogic.webn1.atosresearch.eu", type = JAXBElement.class)
    ...
    public void setOperation(JAXBElement<String> value) {
        this.operation = ((JAXBElement<String> ) value);
    }
