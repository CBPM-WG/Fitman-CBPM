...
public interface Activity extends IActivity{
	 ...
	 * 
	 * 1. Execution related 
	 * 	- Data flow mapping (Parameter info is also kept in the data flow IConnector)
	 *  - Control flow (Parameter info is also used in the Flow's condition
	 ...
	 */
	@Override
        Set<Parameter> getInputParameters();
	@Override
        Set<Parameter> getOutputParameters();
	 ...
	 * @see #setLoopParameter(Parameter)
	 */
	@Override
        Parameter getLoopParameter();
