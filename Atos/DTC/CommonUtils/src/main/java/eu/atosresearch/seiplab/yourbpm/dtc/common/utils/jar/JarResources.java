 ...
 */
package eu.atosresearch.seiplab.yourbpm.dtc.common.utils.jar;
...
public final class JarResources {
   ...
   private String dumpZipEntry(ZipEntry ze) {
	...
	public List<String> listJarFile (String path) throws IOException{
		List<String> result = new ArrayList<String> ();
        JarFile jarFile = new JarFile(jarFileName);
        Enumeration<JarEntry> e = jarFile.entries();
        while (e.hasMoreElements()) {
          String file = filter(e.nextElement(), path);
          if (file != null) {
        	  result.add (file);
          }
        }
	...
	public byte[] loadFileInJar (String file){
		JarResources jr = new JarResources (jarFileName);
		byte[] r = jr.getResource (file);
		return r;
	}

    private static String filter (JarEntry entry, String path) {
