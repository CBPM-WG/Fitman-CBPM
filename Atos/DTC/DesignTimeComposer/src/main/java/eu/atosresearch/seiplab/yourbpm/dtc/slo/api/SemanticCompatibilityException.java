...
public class SemanticCompatibilityException extends Exception {
	...
	private static final long serialVersionUID = 289718501896674667L;

	public SemanticCompatibilityException(Activity a, String msg) {
		super();
